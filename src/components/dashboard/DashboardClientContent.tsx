...
export default function DashboardClientContent() {
    const { organizations, bookmarkedOrgs, toggleBookmark, isBookmarked } = useBookmarks();
        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
                ...
                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-4 lg:p-6 hover:border-purple-500/50 transition-all duration-300">
                    ...
                    <p className="text-2xl lg:text-3xl font-bold text-blue-400">{organizations.reduce((sum, org) => sum + org.issues, 0)}</p>
